  ...
  <div className={`${styles.navbar}`}>
    <div className={`${styles.container}`}>
      ...
      <ul className={`${styles.links}`}>
        ...
        <li className ={`${styles.github}`}><a title="Lance's GitHub" href={github} target="_blank" rel ="noreferrer"> <i className="fa-brands fa-github fa-xl"></i> </a> </li>
        <li className ={`${styles.linkedin}`}><a title="Lance's Linkedin" href={linkedin} target="_blank" rel="noreferrer"> <i className="fa-brands fa-linkedin-in fa-xl"></i> </a> </li>
      </ul>
    </div>
  </div>
  );
